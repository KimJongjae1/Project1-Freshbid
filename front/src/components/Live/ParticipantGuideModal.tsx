...
interface ParticipantGuideModalProps {
  isOpen: boolean;
  onClose: () => void;
}

const ParticipantGuideModal: React.FC<ParticipantGuideModalProps> = ({ isOpen, onClose }) => {
          ...
          <div style={{ 
            ...
            <ul style={{ 
              ...
              <li style={{ 
                ...
                <span>모든 입찰은 수신호 자동 인식 혹은 수동 입찰로 진행됩니다.</span>
              </li>
              <li style={{ 
                marginBottom: '16px',
                display: 'flex',
              ...
              <li style={{ 
                ...
                <span>낙찰이 확정되었다면 알림과 함께 물품은 자동으로 장바구니에 들어갑니다.</span>
              </li>
               <li style={{ 
               marginBottom: '16px',
               display: 'flex',
               ...
               gap: '12px',
                ...
                <span>모든 입찰은 취소 불가능하니 신중하게 입찰해주세요!</span>
              </li>
            </ul>
          </div>
...
export default ParticipantGuideModal;
